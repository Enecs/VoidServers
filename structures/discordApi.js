...
module.exports.refreshUser = async (opts) => {
  ...
  params.append("scope", "identify%20guilds%20guilds.join");
...
module.exports.getUser = async (opts) => {
  ...
  user.guilds = await module.exports.getGuilds();
...
module.exports.addUser = async (opts) => {
  return await opts.client.guilds.cache.get(process.env.GUILD_ID).addMember(opts.userId, { accessToken: opts.accessToken });
};
